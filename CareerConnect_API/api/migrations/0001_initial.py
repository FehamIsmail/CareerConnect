    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('education_level', models.CharField(choices=[('PS', 'Primary School'), ('SS', 'Secondary School'), ('HS', 'High School'), ('BA', 'Bachelor'), ('MA', 'Master'), ('PHD', 'Doctorate')], max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('types', models.CharField(blank=True, choices=[('FULL_TIME', 'Full-time'), ('PART_TIME', 'Part-time'), ('TEMPORARY', 'Temporary'), ('CONTRACT', 'Contract'), ('FREELANCE', 'Freelance'), ('INTERNSHIP', 'Internship'), ('VOLUNTEER', 'Volunteer'), ('SEASONAL', 'Seasonal'), ('REMOTE', 'Remote'), ('CONSULTANT', 'Consultant'), ('EXECUTIVE', 'Executive'), ('REMOTE', 'Remotely'), ('ON_SITE', 'On-site')], max_length=200, null=True)),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.curriculumvitae'),
        ),
        migrations.AddField(
            model_name='application',
